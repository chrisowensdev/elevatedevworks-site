...
export const metadata: Metadata = {
	...
	openGraph: {
		title: "Financial Services Website Design | Elevate DevWorks",
		description:
			"Professional website packages for independent financial professionals—built to increase trust, explain services clearly, and generate better inquiries.",
		url: "/services/financial-services-website/",
		type: "website",
		images: [
			{
				...
				width: 1200,
				height: 630,
				alt: "Elevate DevWorks Financial Services Website Design",
			},
		],
	},
	twitter: {
		...
		title: "Financial Services Website Design | Elevate DevWorks",
		description:
			"Professional website packages for independent financial professionals—starting at $750.",
	},
};

export default function BookkeeperWebsitePage() {
	const p = financialServicesWebsite;
			...
			>
				...
				<SectionCTA
					secondary={{
						...
						text: "View the Bookkeeper product page",
					}}
				/>
			</Section>
