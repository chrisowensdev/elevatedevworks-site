...
export const financialServicesWebsite = {
	slug: "financial-services-websites",
	title: "Financial Services Website Kit",
	subtitle:
		"A modern website built to help independent financial professionals look established and attract better clients",
	description:
		"Productized website packages for independent finance professionals — from a focused landing page to a full multi-page site designed to build trust and generate inquiries.",
	startingPrice: 750,
	...
	outcomes: [
		...
		"Clearly explain financial services without confusing jargon",
	...
	included: [
...

		{
			...
			details: [
				"Monthly financial service explanation",
...

		{
			...
			summary: "A clear step-by-step explanation of your process.",
			details: [
...

		{
			...
			title: "About page",
			summary:
				"A credibility page that introduces the financial services company and approach.",
			details: [
				"Professional bio layout",
				"Approach to financial services and communication",
...

		{
			...
			title: "FAQs page",
			summary:
				"Answer common financial services questions to reduce friction and increase inquiries.",
			details: [
	...
	process: [
...

		{
			...
			title: "Customize",
			description:
				"We tailor the layout, messaging, and service explanations to match your financial services business.",
		},
	...
	packages: [
		{
			...
			price: "$750",
			description:
				"Single-page website designed to help businesses look professional and start collecting inquiries quickly.",
			perfectFor:
				"new financial services businesses, referral-based businesses, or anyone who needs a clean web presence fast.",
			features: [
		...
		},
		{
			...
			price: "$1,250",
			description:
				"Full multi-page website with the core pages most businesses need to build trust and convert inquiries.",
			perfectFor:
				"individuals and small firms who want a polished site without a large custom build.",
			features: [
		...
		},
		{
			...
			price: "$2,500",
			description:
				"Growth + advanced conversion and expansion pages for businesses ready to market more seriously.",
			perfectFor:
				"established businesses who want stronger lead generation, niche targeting, or a more complete online presence.",
			features: [
